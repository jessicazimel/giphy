$(document).ready(function() {
    ...
    var topics = ['Leopard','Kimoto Dragon','Alligator','Flamingo', 'Koala Bear', 'Unicorn', 'Lemur', 'Prairie Dog'];
    ...
    function gifDisplay() {
      ...
      $('.results').append('<h2 class="result_title">Todays Specials: <span>' + $(this).data('name') + ' Gifs!</span></h2>' );
